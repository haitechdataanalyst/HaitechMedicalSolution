...
export async function generateQuotePDF(data: QuotePDFData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      .fontSize(24)
      .fillColor('#0066CC')
      .text('Haitech Medical', 50, 50)
      .fontSize(10)
      .fillColor('#666')
      .text('Premium Medical & Dental Equipment', 50, 80)
      .moveDown();
    ...
    doc
      .fontSize(14)
      .fillColor('#0066CC')
      .text('Requested Items', 50, yPosition);
    ...
    data.items.forEach(item => {
      ...
      doc
        ...
        .text(
          item.basePrice ? formatCurrency(item.basePrice) : 'POA',
          400,
          yPosition,
    ...
    doc
      .text('GST (10%):', 400, yPosition, { width: 70, align: 'right' })
      .text(hasAllPrices ? formatCurrency(total * 0.1) : 'POA', 480, yPosition, { width: 70, align: 'right' });
    ...
    doc
      ...
      .fillColor('#666')
      .text(
        'This is a quote request. Final pricing may vary based on customization options and shipping.',
        50,
        footerY,
        { width: 500, align: 'center' }
      )
      .text(
        'Haitech Medical Australia | info@haitechmedical.com.au | +61 2 8000 1234',
        50,
        footerY + 15,
        { width: 500, align: 'center' }
      )
      .text(
        'www.haitechmedical.com.au',
        50,
        footerY + 30,
        { width: 500, align: 'center' }
      );
