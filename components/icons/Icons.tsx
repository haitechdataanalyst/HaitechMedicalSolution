...
export function MenuIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
...
export function SpinnerIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={`animate-spin ${className || ""}`} width={size} height={size} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
...
// Arrow Back
export function ArrowBackIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
    </svg>
...
export function FacebookIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} width={size} height={size} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function StarIcon({ size = 24, className, filled = false, ...props }: StarIconProps) {
  return (
    <svg className={className} width={size} height={size} fill={filled ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
// Users Icon (for workshops/conferences)
...
// Award Icon (for years of experience)
export function AwardIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg className={className} width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
