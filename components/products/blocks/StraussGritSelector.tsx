...
export default function StraussGritSelector({
  variants,
  selectedVariant,
  onVariantSelect,
}: StraussGritSelectorProps) {
  return (
    <div>
        ...
        {variants.map((variant) => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`absolute left-2 top-2 flex h-7 w-7 items-center justify-center text-xs font-bold ${
                  letter === "M" ? "text-neutral-700" : "text-white"
                } ${bg}`}
