      ...
      {state.success ? (
        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="relative">
            <CountrySelect label="Country" name="country" required value={selectedCountry?.code} onChange={setSelectedCountry} error={state.fieldErrors?.country} placeholder="Select your country" />
          </div>
