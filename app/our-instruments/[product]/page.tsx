...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!product) {
    return {
      title: "Product Not Found | Haitech Medical Solutions",
    };
  }

  return {
    title: `${product.name} - Medesy Instruments | Haitech Medical Solutions`,
...
export default async function MedesyProductPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { name: product.name, path: `/our-instruments/${productSlug}` },
  ];
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-body mb-8 text-gray-600">
              Our team is here to help you find the right instruments for your practice.
            </p>
