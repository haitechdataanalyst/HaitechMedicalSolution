        ...
        <>
            ...
            <section className="bg-primary-gradient relative overflow-hidden text-white">
                <div className="section-lg container">
                    <div className="relative z-10 mx-auto max-w-3xl text-center">
                        ...
                        <p className="text-body-lg text-primary-100">{medesyData.intro.description}</p>
                    </div>
                </div>
                {/* Decorative elements */}
            ...
            <section className="section container">
                <div className="mx-auto max-w-4xl">
                    ...
                    <p className="text-body mb-8 text-center text-gray-600">All our surgical instruments are crafted with precision and designed to last:</p>
            ...
            <section className="section bg-gray-50">
                <div className="container">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="text-body mb-8 text-gray-600">Pair your surgical instruments with our premium dental equipment and loupes for a complete clinical solution.</p>
