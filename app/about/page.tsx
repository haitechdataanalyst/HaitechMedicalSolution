    ...
    return (
        <>
            ...
            <AboutSection title="Our Mission" variant="primary" icon={<Target className="h-8 w-8 text-white" />}>
                <p className="mb-6">
                    Our mission is to enhance the lives of dental & medical professionals—dentists, hygienists, surgeons, & veterinarians—by equipping them with cutting-edge tools to deliver
                    exceptional care & achieve healthier outcomes.
                </p>
                <p>
            ...
            <AboutSection title="Our Vision" variant="light" icon={<Eye className="h-8 w-8" />}>
                <p>
                    To be the most trusted partner in advancing dental and medical excellence by providing innovative, ergonomic, and precision-driven solutions that empower professionals to deliver
