...
export const metadata = {
  title: "Our Frames | Haitech Medical Solutions",
  description:
        ...
        <div className="section-lg container">
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            ...
            <p className="text-body-lg text-primary-100">
              Every professional has their own style. Our premium frames are designed to complement your personality while providing the comfort and durability you need for long working hours.
            </p>
          </div>
        </div>
        {/* Decorative elements */}
      ...
      <section className="section container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-body text-gray-600">
            All our Admetec loupes can be customized with your choice of frame style and color. Whether you prefer the classic elegance of Blues, the bold statement of Jazz, or the timeless appeal of
            Soul, we have the perfect frame waiting for you.
          </p>
        </div>
      </section>
